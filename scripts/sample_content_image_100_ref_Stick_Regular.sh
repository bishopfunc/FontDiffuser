...
exp_name="sample_content_image_100_ref_Stick_Regular"
for (( i=0; i<${#char_list}; i++ )); do
    ...
    python sample.py \
        ...
        --style_image_path="/home/yamamoto/workspace/font-dataset/data/freq-kanji-top500/Stick_Regular/images/愛.png" \
        --save_image \
