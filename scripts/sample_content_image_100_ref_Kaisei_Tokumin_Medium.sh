...
exp_name="sample_content_image_100_ref_Kaisei_Tokumin_Medium"
for (( i=0; i<${#char_list}; i++ )); do
    ...
    python sample.py \
        ...
        --style_image_path="/home/yamamoto/workspace/font-dataset/data/freq-kanji-top500/Kaisei_Tokumin_Medium/images/愛.png" \
        --save_image \
